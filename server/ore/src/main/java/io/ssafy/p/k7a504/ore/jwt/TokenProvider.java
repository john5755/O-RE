...
public class TokenProvider implements InitializingBean {
    ...
    public Authentication getAuthentication(String token) {
        ...
        CustomDetails customDetails = customUserDetailsService.loadUserByUsername(claims.getSubject());
        return new UsernamePasswordAuthenticationToken(customDetails, "", authorities);
    }
